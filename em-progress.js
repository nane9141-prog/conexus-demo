...
(function () {
  ...
  root.innerHTML = '<div class="pg lc">' +
    ...
    card('apply', '사전 참석 신청', '주주들이 주주총회 당일 전자주주총회 시청 및 참여를 위해 미리 신청하는 기간을 설정합니다.',
      '<div class="pg-row">' + dt('pgApS', '시작 일시', '2026-09-11', '09:00') + dt('pgApE', '종료 일시', PREV, '23:59', '총회 전날 24:00까지 설정할 수 있습니다.') + '</div><div class="pg-row">' + unit('pgApN', '참석 인원 제한 (선택)', '1,000', '명').replace('flex:1', 'width:268px') + '</div>', true) +
    card('proxy', '대리인 신청 기간', '주주가 본인 대신 대리인을 지정하여 전자주주총회에 참석 및 의결권을 행사할 수 있도록 신청받는 기간입니다.',
      '<div class="pg-row">' + dt('pgPxS', '시작 일시', '2026-09-11', '09:00', '사전 참석 신청 시작 이후로 설정해 주세요.') + dt('pgPxE', '종료 일시', PREV, '18:00') + '</div>', true) +
